...
public class AutoUpdateIdentityProviderTest extends AbstractAdminTest {
    ...
    public void testAutoUpdatedOIDCIdP() {
        ...
        try {
            ...
            Map<String, String> result = realm.identityProviders().importFrom(map);
            assertThat(result.keySet(), containsInAnyOrder("authorizationUrl", "tokenUrl", "userInfoUrl", "validateSignature", "useJwksUrl", "jwksUrl", "metadataDescriptorUrl","issuer","claimsParameterSupported"));
