...
@NamedNativeQueries({
        @NamedNativeQuery(name="findIdentityProviderSummaryByRealm", query="select INTERNAL_ID, PROVIDER_ID, PROVIDER_ALIAS from identity_provider where REALM_ID = :realmId", resultClass = IdentityProviderEntity.class)
})
