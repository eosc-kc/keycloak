...
public class AuthorizationEndpoint extends AuthorizationEndpointBase {
    ...
    private void checkClient(String clientId, MultivaluedMap<String, String> params) {
        ...
        boolean ishareRequest = realm.getAttribute(Constants.ISHARE_ENABLED, false) && AuthorizationEndpointRequestParserProcessor.hasScope(event, session, params, Constants.ISHARE_SCOPE);
        ...
        if (ishareRequest) {
            ...
            if (client == null) {
                ...
                ClientScopeModel ishareScope = session.clientScopes().addClientScope(realm, Constants.ISHARE_SCOPE);
