        ...
        if (subject != null) {
            ...
            if (userModel != null) {
                ...
                if (clientId != null) {
                    ...
                    accessToken = new TokenManager().createClientAccessToken(keycloakSession, realm, clientModel, userModel, userSession, clientSessionCtx, encoder.encodeTokenId(tokenCtx));
                }
            }
        }
